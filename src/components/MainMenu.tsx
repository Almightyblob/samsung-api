  ...
  return (
    ...
    {productData ? (
      productData.map((product:ProductList) => (
        <MenuItem key={product.fmyMarketingName} active={product.fmyMarketingName === selectedProduct?.fmyMarketingName} onClick={() => setProduct(product)}>{product.fmyMarketingName}</MenuItem>
      )
